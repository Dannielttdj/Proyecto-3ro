...
<form class="mt-4" action="{{ route('login') }}" method="POST">
    ...
    <div class="form-group">
        <label class="form-label form-label-light" for="name">Usuario</label>
        <input type="text" class="form-control form-control-light" id="name" name="name" placeholder="Usuario">
    </div>

    <div class="form-group">
        <label for="password" class="form-label form-label-light d-flex justify-content-between align-items-center">
            Password
        </label>
        <input type="password" class="form-control form-control-light" id="password" name="password" placeholder="password">
    </div>
...
<p class="d-block text-center text-muted small">New customer? <a class=" text-decoration-underline" href="./register.html">Sign up for an account</a></p>
</div>
</div>
<!-- / Login Form-->
